...
public class GameController {
    ...
    public void inicializaCaso(){
        ...
        Cena cenas[] = {
                ...
                new Cena("quarto principal",new Evidencia("óleo nas teclas do cofre", "Utilizando uma lanterna, você percebe que alguém passou uma fina camada de óleo, imperceptível ao olhar desatento \nnas teclas do painel do cofre. Provavelmente através de algum tipo de um spray")),
